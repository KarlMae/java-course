        ...
        final Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (isRunning) {
                    ...
                    mineImage.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
                    mineImage.setY(mine.getyCoordinate());
                    mineImage.setX(mine.getxCoordinate());
                    mineImage.setImageResource(R.drawable.mine);
                    mineImage.getLayoutParams().height = PixelSizeConverter.dpToPx(mine.getMineHeight(), GameActivity.this);
                    mineImage.getLayoutParams().width = PixelSizeConverter.dpToPx(mine.getMineWidth(), GameActivity.this);
