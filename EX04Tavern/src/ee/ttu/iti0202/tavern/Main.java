...
// to shorten the code
        ...
        Purse purse1 = new Purse(new Coin(c), new Coin(c), new Coin(s), new Coin(g)
        );

        System.out.println(purse1.pay(Price.of(12))); // [1 silver, 1 silver, 1 silver]   should not be 1 gold
    }
}
